...
export const LearnerJourneyRoadmap: React.FC<LearnerJourneyRoadmapProps> = ({
  ...
  return (
    <div
      ...
      className="bg-white rounded-[28px] p-4 sm:p-5 border border-slate-200/80 shadow-xs space-y-3.5 select-none"
    >
      {/* CARD HEADER: WHERE AM I? */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-2xl bg-[#7025fb] text-white flex items-center justify-center shadow-xs">
            <Sparkles className="w-4 h-4" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-black uppercase tracking-wider text-[#7025fb] bg-purple-50 px-2.5 py-0.5 rounded-full border border-purple-100">
